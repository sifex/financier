...
use Sifex\Financier\PaymentGateway\PaymentGateway;
...
class TestPaymentGateway implements PaymentGateway
{
    ...
    public function createOrganisationAccount(AccountInterface $account): Collection
    {
        return collect([
     ...
     * @return Collection
     */
    public function getOrganisationAccount(AccountInterface $account): Collection
    {
        return collect([
            'payment_gateway_account_id' => 'acct_123456789ABCDEF',
        ]);
     ...
     * @return Collection
     */
    public function updateOrganisationAccount(AccountInterface $account): Collection
    {
        return collect([
            'payment_gateway_account_id' => 'acct_123456789ABCDEF',
        ]);
     ...
     * @return Collection
     */
    public function getAllOrganisationBankAccounts(AccountInterface $account): Collection
    {
        return collect([
            collect([
     ...
     * @return Collection
     */
    public function getOrganisationBankAccount(AccountInterface $account, string $bankAccountID): Collection
    {
        return collect([
     ...
     * @return Collection
     */
    public function addOrganisationBankAccount(AccountInterface $account, string $token): Collection
    {
        return collect([
            'payment_gateway_bank_account_id' => 'ba_123456789',
            'bank_name' => 'Commbank',
     ...
     * @return Collection
     */
    public function removeOrganisationBankAccount(AccountInterface $account, string $bankAccountID): Collection
    {
        return collect([
            'payment_gateway_bank_account_id' => 'ba_123456789',
            'object' => 'bank_account',
